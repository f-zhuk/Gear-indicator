...
static const uint8_t glyph_bitmap_unscii_8[] = {
    /* U+0020 " " */
    0x0,
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc_unscii_8[] = {
...
font_t lv_font_unscii_8 = {
    .line_height = 9,          /*The maximum line height required by the font*/
    .base_line = 0,             /*Baseline measured from the bottom of the line*/
    .glyph_bitmap = glyph_bitmap_unscii_8,    /*Function pointer to get glyph's bitmap*/
    .glyph_dsc = glyph_dsc_unscii_8,    /*Function pointer to get glyph's data*/
    .cmaps = cmaps,
    .cmap_num = 1,
    .bpp = 1
};
